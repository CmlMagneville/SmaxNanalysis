...
## ... a given species : Chaetodon trifasciatus
##
## Serveur_sp4_SmaxN.R
##
## 06/06/2022
...
SmaxN_C_trifasciatus <- automat.maxN.spbysp(species_nm,
                    abund_list,
                    dist_df,
                    fish_speed = 0.5,
                    os = "linux",
                    nb_cores = 3)
saveRDS(SmaxN_C_trifasciatus$maxN_sp, "SmaxN_C_trif_df.rds")
saveRDS(SmaxN_C_trifasciatus$time.taken, "SmaxN_C_trif_timetaken.rds")
