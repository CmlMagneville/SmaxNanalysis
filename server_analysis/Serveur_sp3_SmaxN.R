...
## ... a given species : Parupeneus macronemus
##
## Serveur_sp3_SmaxN.R
##
## 06/06/2022
...
SmaxN_P_macronemus <- automat.maxN.spbysp(species_nm,
                    abund_list,
                    dist_df,
                    fish_speed = 0.5,
                    os = "linux",
                    nb_cores = 3)
saveRDS(SmaxN_P_macronemus$maxN_sp, "SmaxN_P_macronemus_df.rds")
saveRDS(SmaxN_P_macronemus$time.taken, "SmaxN_P_macronemus_timetaken.rds")
